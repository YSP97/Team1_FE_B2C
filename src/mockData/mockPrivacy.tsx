export const mockPrivacy = [
  {
    title: "제 1조(목적)",
    content:
      "핏큘레이터(이하 ’회사’ 라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 ’정보통신망법’) 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.",
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        list: "2. 회사는 제1항에 따라 본 방침을 개정하는 경우 다음 각 호 하나 이상의 방법으로 공지합니다.",
        desc: [
  ...
  },
  {
    ...
    content: [
      ...
      {
        list: "필수 수집 정보",
        desc: ["이메일 주소, 비밀번호, 이름, 닉네임, 생년월일 및 휴대폰 번호"],
      },
    ],
  },
  {
    ...
    content: [
      "회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.",
      {
        list: "필수 수집 정보",
        desc: [
          "휴대폰 번호, 이메일 주소, 이름, 생년월일, 성별, 본인확인값(CI,DI), 이동통신사, 아이핀 정보(아이핀 확인 시) 및 내/외국인 여부",
        ],
      },
    ],
  },
  {
    ...
    content: [
      "회사는 법정대리인의 동의가 필요한 경우 법정대리인의 동의를 위하여 다음과 같은 정보를 수집합니다.",
      {
        list: "필수 수집 정보",
        desc: [
          "보호자 이름, 보호자 생년월일, 보호자 성별, 보호자 내/외국인 여부, 보호자 휴대폰 번호, 보호자 이동통신사 정보, 보호자 아이핀 정보(아이핀 확인 시), 보호자 본인확인값(CI,DI) 및 본인과의 관계",
        ],
      },
    ],
  },
  {
    ...
    content: [
      "회사는 이용자에게 회사의 결제 서비스 제공을 위하여 다음과 같은 정보를 수집합니다.",
      {
        list: "필수 수집 정보",
        desc: [
          "카드번호, 카드비밀번호, 유효기간, 생년월일 6자리(yy/mm/dd), 은행명 및 계좌번호",
        ],
      },
    ],
  },
  {
    ...
    content: [
      "회사는 이용자의 현금영수증을 발행하기 위하여 다음과 같은 정보를 수집합니다.",
      {
        list: "필수 수집 정보",
        desc: [
          "현금영수증 발행 대상자 이름, 현금영수증 발행 대상자 생년월일, 현금영수증 발행 대상자 주소, 휴대폰 번호 및 현금영수증 카드번호",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      {
        list: "필수 수집 정보",
        desc: ["서비스 이용기록, 쿠키, 접속지 정보 및 기기정보"],
      },
    ],
  },
  {
    ...
    content: [
      {
        list: "회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다.",
        desc: [
  ...
  },
  {
    ...
    content: [
      {
        list: "회사는 개인정보를 다음 각 호의 경우에 이용합니다.",
        desc: [
  ...
  },
  {
    ...
    content: [
      {
        list: "회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.",
        desc: [
  ...
  },
  {
    ...
    content: [
      {
        list: "회사는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 회사가 수집하는 ‘개인정보의 보유 및 이용기간 ’에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.",
        desc: [
          "유출 등이 된 개인정보 항목",
          "유출 등이 발생한 시점",
          "이용자가 취할 수 있는 조치",
  ...
  },
  {
    ...
    content: [
      {
        list: "회사는 개인정보의 분실·도난·유출(이하 ‘유출 등 ’ 이라 한다) 사실을 안 때에는 지체 없이 다음 각 호의 모든 사항을 해당 이용자에게 알리고 방송통신위원회 또는 한국인터넷진흥원에 신고합니다.",
        desc: [
          "유출 등이 된 개인정보 항목",
          "유출 등이 발생한 시점",
          "이용자가 취할 수 있는 조치",
  ...
  },
  {
    ...
    content: [
      ...
      {
        list: "회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각 호의 사항 모두를 이용자에게 고지합니다.",
        desc: [
          "이전되는 개인정보 항목",
  ...
  },
  {
    ...
    content: [
      {
        list: "웹브라우저 옵션 설정을 통해 쿠키 허용, 쿠키 차단 등의 설정을 할 수 있습니다.",
        desc: [
  ...
  },
  {
    ...
    content: [
      ...
      {
        list: "정보주체는 개인정보침해로 인한 구제를 받기 위하여 개인정보분쟁조정위원회, 한국인터넷진흥원 개인정보침해신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기 바랍니다.",
        desc: [
