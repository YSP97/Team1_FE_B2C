...
export default function Pricing() {
  ...
  return (
    <>
      <Head>
        <title>Pricing | 핏큘레이터</title>
        <meta
          name="description"
          content="핏큘레이터의 다양한 운동 플랜을 확인하고 나에게 맞는 플랜을 신청하세요."
        />
        <meta
          name="keywords"
          content="운동, 피트니스, 헬스, 온라인 트레이닝, 맞춤형 플랜"
        />
        <meta name="author" content="핏큘레이터" />
        <meta property="og:title" content="Pricing | 핏큘레이터" />
        <meta
          property="og:description"
          content="핏큘레이터에서 나에게 딱 맞는 운동 플랜을 찾아보세요."
        />
        <meta content="핏큘레이터에서 나에게 딱 맞는 운동 플랜을 찾아보세요." />
      </Head>
